...
SimpleForm.setup do |config|
  ...
  config.button_class = "btn btn-primary w-100 mb-3"
  ...
  config.wrappers :vertical_form, tag: "div", class: "form-group mb-3", error_class: "form-group-invalid",
  ...
  config.wrappers :vertical_boolean, tag: "fieldset", class: "form-group mb-3", error_class: "form-group-invalid",
    valid_class: "form-group-valid" do |b|
    b.use :html5
    b.optional :readonly
